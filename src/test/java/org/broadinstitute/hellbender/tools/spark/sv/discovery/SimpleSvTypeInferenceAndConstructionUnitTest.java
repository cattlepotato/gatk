...
public class SimpleSvTypeInferenceAndConstructionUnitTest extends BaseTest {
    ...
    private Object[][] forTypeInference() {
        ...
        data.add(new Object[]{forSimpleTanDupContraction_plus._3(), DEL.name(), ImmutableSet.of(TANDUP_CONTRACTION_STRING)});

        // simple tandem dup expansion from 1 unit to 2 units
        data.add(new Object[]{forSimpleTanDupExpansion_minus._3(), DUP.name(), ImmutableSet.of(TANDUP_EXPANSION_STRING)});

        // simple tandem dup expansion from 1 unit to 2 units and novel insertion
        data.add(new Object[]{forSimpleTanDupExpansionWithNovelIns_plus._3(), DUP.name(), ImmutableSet.of(TANDUP_EXPANSION_STRING)});

        // tandem dup expansion from 1 unit to 2 units with pseudo-homology
        data.add(new Object[]{forComplexTanDup_1to2_pseudoHom_minus._3(), DUP.name(), ImmutableSet.of(TANDUP_EXPANSION_STRING)});

        // tandem dup contraction from 2 units to 1 unit with pseudo-homology
        data.add(new Object[]{forComplexTanDup_2to1_pseudoHom_plus._3(), DEL.name(), ImmutableSet.of(TANDUP_CONTRACTION_STRING)});

        // tandem dup contraction from 3 units to 2 units
        data.add(new Object[]{forComplexTanDup_3to2_noPseudoHom_minus._3(), DEL.name(), ImmutableSet.of(TANDUP_CONTRACTION_STRING)});

        // tandem dup expansion from 2 units to 3 units
        data.add(new Object[]{forComplexTanDup_2to3_noPseudoHom_plus._3(), DUP.name(), ImmutableSet.of(TANDUP_EXPANSION_STRING)});
    ...
    private Object[][] forAltAlleleSvLenAndIdProductions(){
        ...
        data.add(new Object[]{forSimpleTanDupExpansionWithNovelIns_plus._3(), inferFromNovelAdjacency(forSimpleTanDupExpansionWithNovelIns_plus._3()),
                SYMB_ALT_ALLELE_DUP_IN_HEADER, 99,
                TANDUP_EXPANSION_INTERNAL_ID_START_STRING});
        ...
        data.add(new Object[]{forComplexTanDup_1to2_pseudoHom_minus._3(), inferFromNovelAdjacency(forComplexTanDup_1to2_pseudoHom_minus._3()),
                SYMB_ALT_ALLELE_DUP_IN_HEADER, 96,
                TANDUP_EXPANSION_INTERNAL_ID_START_STRING});
        ...
        data.add(new Object[]{forComplexTanDup_2to1_pseudoHom_plus._3(), inferFromNovelAdjacency(forComplexTanDup_2to1_pseudoHom_plus._3()),
                SYMB_ALT_ALLELE_DEL_IN_HEADER, -96,
                TANDUP_CONTRACTION_INTERNAL_ID_START_STRING});
